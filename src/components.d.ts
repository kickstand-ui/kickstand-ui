...
import {
    FormFieldValue,
    IFormFieldData,
} from './scripts/components/form-field/form-field';
import { IFormData } from './scripts/components/form/form';
import {
    FormFieldValue as FormFieldValue1,
    IFormFieldData as IFormFieldData1,
} from './scripts/components/form-field/form-field';
...
declare global {
    ...
    interface HTMLKsButtonBarElement
        extends Components.KsButtonBar,
            HTMLStencilElement {}
    ...
    interface HTMLKsFormFieldElement
        extends Components.KsFormField,
            HTMLStencilElement {}
    var HTMLKsFormFieldElement: {
        prototype: HTMLKsFormFieldElement;
        new (): HTMLKsFormFieldElement;
    };
    interface HTMLKsGalleryElement
        extends Components.KsGallery,
            HTMLStencilElement {}
    ...
    interface HTMLKsTooltipElement
        extends Components.KsTooltip,
            HTMLStencilElement {}
...
declare module '@stencil/core' {
    export namespace JSX {
        interface IntrinsicElements {
            'ks-accordion': LocalJSX.KsAccordion &
                JSXBase.HTMLAttributes<HTMLKsAccordionElement>;
            'ks-accordion-slide': LocalJSX.KsAccordionSlide &
                JSXBase.HTMLAttributes<HTMLKsAccordionSlideElement>;
            'ks-alert': LocalJSX.KsAlert &
                JSXBase.HTMLAttributes<HTMLKsAlertElement>;
            'ks-autocomplete': LocalJSX.KsAutocomplete &
                JSXBase.HTMLAttributes<HTMLKsAutocompleteElement>;
            'ks-badge': LocalJSX.KsBadge &
                JSXBase.HTMLAttributes<HTMLKsBadgeElement>;
            'ks-breadcrumbs': LocalJSX.KsBreadcrumbs &
                JSXBase.HTMLAttributes<HTMLKsBreadcrumbsElement>;
            'ks-button': LocalJSX.KsButton &
                JSXBase.HTMLAttributes<HTMLKsButtonElement>;
            'ks-button-bar': LocalJSX.KsButtonBar &
                JSXBase.HTMLAttributes<HTMLKsButtonBarElement>;
            'ks-card': LocalJSX.KsCard &
                JSXBase.HTMLAttributes<HTMLKsCardElement>;
            'ks-card-body': LocalJSX.KsCardBody &
                JSXBase.HTMLAttributes<HTMLKsCardBodyElement>;
            'ks-card-footer': LocalJSX.KsCardFooter &
                JSXBase.HTMLAttributes<HTMLKsCardFooterElement>;
            'ks-carousel': LocalJSX.KsCarousel &
                JSXBase.HTMLAttributes<HTMLKsCarouselElement>;
            'ks-carousel-slide': LocalJSX.KsCarouselSlide &
                JSXBase.HTMLAttributes<HTMLKsCarouselSlideElement>;
            'ks-checkbox': LocalJSX.KsCheckbox &
                JSXBase.HTMLAttributes<HTMLKsCheckboxElement>;
            'ks-checklist': LocalJSX.KsChecklist &
                JSXBase.HTMLAttributes<HTMLKsChecklistElement>;
            'ks-column': LocalJSX.KsColumn &
                JSXBase.HTMLAttributes<HTMLKsColumnElement>;
            'ks-dropdown': LocalJSX.KsDropdown &
                JSXBase.HTMLAttributes<HTMLKsDropdownElement>;
            'ks-dropdown-item': LocalJSX.KsDropdownItem &
                JSXBase.HTMLAttributes<HTMLKsDropdownItemElement>;
            'ks-form': LocalJSX.KsForm &
                JSXBase.HTMLAttributes<HTMLKsFormElement>;
            'ks-form-field': LocalJSX.KsFormField &
                JSXBase.HTMLAttributes<HTMLKsFormFieldElement>;
            'ks-gallery': LocalJSX.KsGallery &
                JSXBase.HTMLAttributes<HTMLKsGalleryElement>;
            'ks-icon': LocalJSX.KsIcon &
                JSXBase.HTMLAttributes<HTMLKsIconElement>;
            'ks-img': LocalJSX.KsImg & JSXBase.HTMLAttributes<HTMLKsImgElement>;
            'ks-loading': LocalJSX.KsLoading &
                JSXBase.HTMLAttributes<HTMLKsLoadingElement>;
            'ks-loading-overlay': LocalJSX.KsLoadingOverlay &
                JSXBase.HTMLAttributes<HTMLKsLoadingOverlayElement>;
            'ks-menu-bar': LocalJSX.KsMenuBar &
                JSXBase.HTMLAttributes<HTMLKsMenuBarElement>;
            'ks-menu-group': LocalJSX.KsMenuGroup &
                JSXBase.HTMLAttributes<HTMLKsMenuGroupElement>;
            'ks-menu-item': LocalJSX.KsMenuItem &
                JSXBase.HTMLAttributes<HTMLKsMenuItemElement>;
            'ks-menu-row': LocalJSX.KsMenuRow &
                JSXBase.HTMLAttributes<HTMLKsMenuRowElement>;
            'ks-modal': LocalJSX.KsModal &
                JSXBase.HTMLAttributes<HTMLKsModalElement>;
            'ks-modal-footer': LocalJSX.KsModalFooter &
                JSXBase.HTMLAttributes<HTMLKsModalFooterElement>;
            'ks-overlay': LocalJSX.KsOverlay &
                JSXBase.HTMLAttributes<HTMLKsOverlayElement>;
            'ks-progress-bar': LocalJSX.KsProgressBar &
                JSXBase.HTMLAttributes<HTMLKsProgressBarElement>;
            'ks-radio': LocalJSX.KsRadio &
                JSXBase.HTMLAttributes<HTMLKsRadioElement>;
            'ks-responsive-embed': LocalJSX.KsResponsiveEmbed &
                JSXBase.HTMLAttributes<HTMLKsResponsiveEmbedElement>;
            'ks-row': LocalJSX.KsRow & JSXBase.HTMLAttributes<HTMLKsRowElement>;
            'ks-scroll-to-top': LocalJSX.KsScrollToTop &
                JSXBase.HTMLAttributes<HTMLKsScrollToTopElement>;
            'ks-side-drawer': LocalJSX.KsSideDrawer &
                JSXBase.HTMLAttributes<HTMLKsSideDrawerElement>;
            'ks-spin-box': LocalJSX.KsSpinBox &
                JSXBase.HTMLAttributes<HTMLKsSpinBoxElement>;
            'ks-switch': LocalJSX.KsSwitch &
                JSXBase.HTMLAttributes<HTMLKsSwitchElement>;
            'ks-tab': LocalJSX.KsTab & JSXBase.HTMLAttributes<HTMLKsTabElement>;
            'ks-tabs': LocalJSX.KsTabs &
                JSXBase.HTMLAttributes<HTMLKsTabsElement>;
            'ks-tooltip': LocalJSX.KsTooltip &
                JSXBase.HTMLAttributes<HTMLKsTooltipElement>;
        }
    }
}
