...
export const lazyImage = () => {
    ...
    const fallbackSrc = text(
        'fallback-src',
        'https://imgix.bustle.com/rehost/2016/9/13/ffa8cec2-85d9-40ad-b386-906b75bf5610.jpg?w=970&h=582&fit=crop&crop=faces&auto=format&q=70'
    );
    const src2 = text(
        'src2',
        'https://i.pinimg.com/originals/84/dd/ee/84ddee6dff0e2af20754826aecbc5c11.jpg'
    );
