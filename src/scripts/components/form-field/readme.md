...
| `disableErrorMessage`   | `disable-error-message`   |             | `boolean`                                                                                                                                                                                                                                          | `false`                                                                                                               |
...
| `maxErrorMessage`       | `max-error-message`       |             | `string`                                                                                                                                                                                                                                           | ``Your value must be less than ${this.max + 1}.``                                                                     |
...
| `minErrorMessage`       | `min-error-message`       |             | `string`                                                                                                                                                                                                                                           | ``Your value must be greater than ${this.min - 1}.``                                                                  |
