...
export const defaultHeading = () => {
    ...
    const heading = text('heading', 'The Facts of Life by Michael Scott');
    ...
    return (`
        <div class="m-xxl">
            <ks-alert id="alert_test" icon="${icon}" hide-icon="${hideIcon}" heading="${heading}" note="${note}" color="${color}" dismissible="${dismissible}" display="${display}">${dummyText}</ks-alert>
