...
export const carouselOptions = () => {
    ...
    const cssClass = text('class', 'm-md');
...
export const carouselSlideOptions = () => {
    ...
    return (`
        <ks-carousel autoplay="true" class="${cssClass}">
            <ks-carousel-slide href="${href}" position="${position}" align="${align}" alt="Jim Pranks Dwight" src="https://oyster.ignimgs.com/wordpress/stg.ign.com/2013/05/Jims_wall_of_pencils.png">
                <h2>Desk Fort</h2>
            </ks-carousel-slide>
            <ks-carousel-slide href="${href}" position="${position}" align="${align}" alt="Jim Pranks Dwight" src="https://img.buzzfeed.com/buzzfeed-static/static/2015-07/17/14/enhanced/webdr08/enhanced-4901-1437158753-3.jpg">
