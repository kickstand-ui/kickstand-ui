...
export const defaultTabs = () => {
    ...
    return (`                            
        <ks-tabs class="m-xxl" position="${position}" name="categories" style="max-width: 900px;">
            <ks-tab-list>
                <ks-tab controls="test-1">Three Hole Punch Jim</ks-tab>
                <ks-tab controls="test-1">Dave</ks-tab>
                <ks-tab controls="test-2">Facebook</ks-tab>
                <ks-tab controls="test-3">Popeye</ks-tab>
            </ks-tab-list>
